...
st.markdown("""<div class ="centered-content"><div class="box"><h3>Notre jeu de donnée lors du démarrage et son évolution</h3>
    ...
    <p>NB: nous aurions pu avoir accès à des données plus riches, mais cela impliquait des abonnements payants, ce qui était contraire à l’esprit du projet.</p><br><br>
    <img src="https://github.com/NicolasDartois/streamlit_2/blob/main/images/end.jpg?raw=true" class="fit-img"/>""", unsafe_allow_html=True)
