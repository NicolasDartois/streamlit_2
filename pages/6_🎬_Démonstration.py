...
with col2: 
            if st.button('Scotty, lance la prédiction !'):
                ...
                st.write(f'Le modèle predit <span style="font-size:20px; color:#82E0AA;"><b>{str(round(prediction[0]))}</b></span> entrées la première semaine en france.', unsafe_allow_html=True)
