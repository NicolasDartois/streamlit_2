...
st.markdown("""
  <div class ="centered-content">
      ...
      Ce modèle s\'appuiera sur des données préalablement collectées, alliant des critères quantitatifs et qualitatifs pour établir ses prévisions.</p></div>
    </div>
    <div id="content2">
      ...
      En renseignant des paramètres spécifiques de son choix, l\'utilisateur pourra obtenir rapidement une estimation précise des entrées en salle.</p></div>
    </div>
    <div id="content3">
      ...
      Cette démarche nous a permis de nous approprier efficacement cet outil moderne, en vue de l\'utiliser plus tard dans nos futures carrières.</p></div>
    </div>
  </div>
